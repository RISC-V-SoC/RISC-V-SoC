...
src_library.add_source_files(SRC_PATH / "timer_register" / "*.vhd")
tb_library.add_source_files(SRC_PATH / "timer_register" / "test" / "*.vhd")

src_library.add_source_files(SRC_PATH / "platform_level_interrupt_controller" / "*.vhd")
tb_library.add_source_files(SRC_PATH / "platform_level_interrupt_controller" / "test" / "*.vhd")
